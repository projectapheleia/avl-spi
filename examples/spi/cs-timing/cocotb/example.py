...
async def test(dut):
    """
    Example SPI mode 0 with chip select timing checks
        - Interface CS_SETUP 3, CS_HOLD 2 and CS_GAP 4 clk cycles
        - SCLK half period of 1 clk cycle
        - 50 back-to-back 8-bit transfers
        - Master cs_setup, cs_hold and cs_gap default to the interface minimums
        - random miso
    ...
    avl.Factory.set_variable("*.agent.msqr.mseq.n_items", 50)
